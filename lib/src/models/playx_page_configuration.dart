...
///
/// This class provides extensive control over route transitions, modal
/// behavior, state management, and more.
class PlayxPageConfiguration<T> {
  ...
  /// Creates a [PlayxPageConfiguration] with default transitions.
  ///
  /// If a custom transition is not provided, it defaults to a simple transition
  /// with a 300ms duration.
  ...
  /// Creates a [PlayxPageConfiguration] with a custom transition.
  ///
  /// This constructor allows you to define a custom [transitionsBuilder],
  /// as well as customize various other aspects of the route, such as
  /// [transitionDuration], [reverseTransitionDuration], [barrierColor],
  /// and more.
